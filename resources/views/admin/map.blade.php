...
@section('content')
      ...
      <head>
        ...
        <link rel="stylesheet" type="text/cs" media="all" href="http://vodacom.registersim.com/assets/dashboard/js/daterangepicker-bs3.css')}}" />
  ...
  <script src="{{asset('build/js/new-custom.js')}}"></script>
