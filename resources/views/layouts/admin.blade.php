...
<html lang="en">
  <head>
    ...
    <title>UAF LMS! |@yield('title') </title>
    @stack('css')
  </head>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="{{route('index2')}}">Dashboard2</a></li>
                  ...
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="{{route('form-advance')}}">Advanced Components</a></li>
                  ...
                  <li><a><i class="fa fa-desktop"></i> UI Elements <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="{{route('media_gallary')}}">Media Gallery</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="{{route('tables-dynamic')}}">Table Dynamic</a></li>
                    </ul>
                  </li>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="{{route('page_404')}}">404 Error</a></li>
                      <li><a href="{{route('page_500')}}">500 Error</a></li>
